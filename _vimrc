...
augroup configgroup
    ...
    autocmd FileType sls setlocal tabstop=2
    autocmd FileType sls setlocal shiftwidth=2
    autocmd FileType sls setlocal softtabstop=2
    autocmd FileType sls setlocal signcolumn=yes
    ...
    autocmd FileType jinja setlocal signcolumn=yes
